...
const projects=`
  <ul>
    ...
    <b>Tech Stack: Node.js, Express.js, MongoDb, Mongoose</b></li><br>
    ...
    <b>Tech Stack: HTML, CSS, JavaScript, Bootstrap, REST APIs, DOM Manipulation</b></li><br>
...
<div>
  ...
  <p> -> Worked on the development of Coupon Store Web Application using Spring Boot which is a unified platform to add, update and activate different coupons.<br><br>
  -> Worked in invenotry management team of JioMart which provided web applications to push and update items.<br><br>
  <b>Tech Stack:</b> Spring Boot, MySql</p>
</div>`;

const skills=`
<div>
  <ul>
    <li><b>Languages: </b>Java, C++, JavaScript, HTML, CSS</li><br>
